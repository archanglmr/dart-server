...
function CricketMark({marks, defaultText = '', highlight = 0}) {
  ...
  return (
      <svg className={className.svg.join(' ')} version="1.1" x="0px" y="0px" width="100px" height="100px" viewBox="0 0 100 100" enable-background="new 0 0 100 100">
        ...
        <g transform={`rotate(45, 50, 50)`}>
          ...
          <circle className={className.mark3.join(' ')} cx="50" cy="50" r="44"></circle>
        </g>
      </svg>
  );
}
