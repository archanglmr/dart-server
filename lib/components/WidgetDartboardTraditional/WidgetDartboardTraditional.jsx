...
import './WidgetDartboardTraditional.scss';
...
function WidgetDartboardTraditional({dartboard}) {
  var order = [20, 1, 18, 4, 13, 6, 10, 15, 2, 17, 3, 19, 7, 16, 8, 11, 14, 9, 12, 5],
      bullClassNames = {
        double: ['dark', 'double'],
        outer: ['light', 'single']
      },
      className = ['widget-dartboard', 'widget-dartboard-traditional'];
...
WidgetDartboardTraditional.propTypes = {
...
export default WidgetDartboardTraditional;